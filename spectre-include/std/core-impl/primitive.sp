...
namespace std {	
	namespace core {
		...
		namespace _detail {
			...
			func[static] type primitive primitive_signed_int(const signed int s __rfuncarg__) {
				type primitive pt;
				int* p = pt.__dummy$;
				__asm__ (
					p "$8" :
		...
		namespace _detail {
			...
			func[static] type primitive primitive_unsigned_int(const unsigned int u __rfuncarg__) {
				type primitive pt;
				int* p = pt.__dummy$;
				__asm__ (
					p "$8" :
		...
		namespace _detail {
			...
			func[static] type primitive primitive_signed_byte(const signed byte b __rfuncarg__) {
				type primitive pt;
				int* d = pt.__dummy$;
				__asm__ (
					d "$8" :
		...
		func type primitive primitive_byte(const signed byte b __rfuncarg__) {
		...
		namespace _detail {
			...
			func[static] type primitive primitive_unsigned_byte(const unsigned byte u __rfuncarg__) {
				type primitive pt;
				int* d = pt.__dummy$;
				__asm__ (
					d "$8" :
		...
		func type primitive primitive_ubyte(const unsigned byte u __rfuncarg__) {
		...
		namespace _detail {
			...
			func[static] type primitive primitive_signed_char(const signed char c __rfuncarg__) {
				type primitive pt;
				int* d = pt.__dummy$;
				__asm__ (
					d "$8" :
		...
		func type primitive primitive_char(const signed char c __rfuncarg__) {
		...
		namespace _detail {
			...
			func[static] type primitive primitive_unsigned_char(const unsigned char u __rfuncarg__) {
				type primitive pt;
				int* d = pt.__dummy$;
				__asm__ (
					d "$8" :
		...
		func type primitive primitive_uchar(const unsigned char u __rfuncarg__) {
		...
		func type primitive primitive_bool(const bool b __rfuncarg__) {
			type primitive pt;
			int* d = pt.__dummy$;
			__asm__ (
				d "$8" :
		...
		namespace _detail {
			...
			func[static] type primitive primitive_signed_short(const signed short s __rfuncarg__) {
				type primitive pt;
				int* d = pt.__dummy$;
				__asm__ (
					d "$8" :
		...
		func type primitive primitive_short(const signed short s __rfuncarg__) {
		...
		namespace _detail {
			...
			func[static] type primitive primitive_unsigned_short(const unsigned short u __rfuncarg__) {
				type primitive pt;
				int* d = pt.__dummy$;
				__asm__ (
					d "$8" :
		...
		func type primitive primitive_ushort(const unsigned short u __rfuncarg__) {
		...
		namespace _detail {
			...
			func[static] type primitive primitive_signed_long(const signed long s __rfuncarg__) {
				type primitive pt;
				int* d = pt.__dummy$;
				__asm__ (
					d "$8" :
		...
		func type primitive primitive_long(const signed long s __rfuncarg__) {
		...
		namespace _detail {
			...
			func[static] type primitive primitive_unsigned_long(const unsigned long u __rfuncarg__) {
				type primitive pt;
				int* d = pt.__dummy$;
				__asm__ (
					d "$8" :
		...
		func type primitive primitive_ulong(const unsigned long u __rfuncarg__) {
		...
		func const unsigned int bits_from_float(const float f __rfuncarg__) {
			unsigned int ret;
			__asm__ (
				ret "$9" :
				"swc1 $f12, 0($9)"
		...
		func const float float_from_bits(const unsigned int u __rfuncarg__) {
			float ret;
			__asm__ (
				ret "$9" :
				"mtc1 $4, $f4" :
		...
		func type primitive primitive_float(const float f __rfuncarg__) {
			type primitive pt;
		...
		func type primitive primitive_double(const double d __rfuncarg__) {
			type primitive pt;
			int* dp = pt.__dummy$;
			__asm__ (
				dp "$8" :
